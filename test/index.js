...
describe('zeros function', function () {
  it('should produce lots of 0s', function () {
    ...
    assert.strictEqual(z60.toString('hex'), zs60)
  })
})
...
describe('sha3', function () {
  it('should produce a sha3', function () {
    ...
    assert.strictEqual(hash.toString('hex'), r)
  })
})
...
describe('rpad', function () {
  it('should right pad a Buffer', function () {
    ...
    assert.strictEqual(padded.toString('hex'), '090900')
  })
  it('should right truncate a Buffer', function () {
    var buf = Buffer.from([9, 0, 9])
    var padded = ethUtils.setLength(buf, 2, true)
    assert.strictEqual(padded.toString('hex'), '0900')
  })
...
describe('intToBuffer', function () {
  it('should convert a int to a buffer', function () {
    ...
    assert.strictEqual(buf.toString('hex'), '5b9ac8')
  })
})
...
describe('bufferToInt', function () {
  it('should convert a int to hex', function () {
    ...
    assert.strictEqual(ethUtils.bufferToInt(Buffer.allocUnsafe(0)), 0)
  })
...
describe('fromSigned', function () {
  it('should convert an unsigned (negative) buffer to a singed number', function () {
    ...
    assert.strictEqual(ethUtils.fromSigned(buf).toString(), neg)
  })
...
describe('toUnsigned', function () {
  it('should convert a signed (negative) number to unsigned', function () {
    ...
    assert.strictEqual(ethUtils.toUnsigned(num).toString('hex'), hex)
  })
...
describe('isValidPrivate', function () {
  ...
  it('should fail on short input', function () {
    var tmp = '0011223344'
    assert.strictEqual(ethUtils.isValidPrivate(Buffer.from(tmp, 'hex')), false)
  })
  ...
  it('should work otherwise (< N)', function () {
    ...
    assert.strictEqual(ethUtils.isValidPrivate(Buffer.from(tmp, 'hex')), true)
  })
})
...
describe('isValidPublic', function () {
  it('should fail on too short input', function () {
    ...
    assert.strictEqual(ethUtils.isValidPublic(pubKey), false)
  })
  it('should fail on too big input', function () {
  ...
  it('shouldn\'t fail on SEC1 key with sanitize enabled', function () {
    var pubKey = '043a443d8381a6798a70c6ff9304bdc8cb0163c23211d11628fae52ef9e0dca11a001cf066d56a8156fc201cd5df8a36ef694eecd258903fca7086c1fae7441e1d'
    pubKey = Buffer.from(pubKey, 'hex')
    assert.strictEqual(ethUtils.isValidPublic(pubKey, true), true)
  })
  it('should fail with an invalid SEC1 public key', function () {
    ...
    pubKey = Buffer.from(pubKey, 'hex')
    assert.strictEqual(ethUtils.isValidPublic(pubKey, true), false)
  })
  ...
  it('should work otherwise', function () {
    ...
    pubKey = Buffer.from(pubKey, 'hex')
    assert.strictEqual(ethUtils.isValidPublic(pubKey), true)
  })
})
...
describe('importPublic', function () {
  ...
  it('should work with an Ethereum public key', function () {
    var tmp = '3a443d8381a6798a70c6ff9304bdc8cb0163c23211d11628fae52ef9e0dca11a001cf066d56a8156fc201cd5df8a36ef694eecd258903fca7086c1fae7441e1d'
    assert.strictEqual(ethUtils.importPublic(Buffer.from(tmp, 'hex')).toString('hex'), pubKey)
  })
...
describe('generateAddress', function () {
  it('should produce an address given a public key', function () {
    ...
    assert.strictEqual(add.toString('hex'), '936a4295d8d74e310c0c95f0a63e53737b998d12')
  })
})
...
describe('generateAddress with hex prefix', function () {
  it('should produce an address given a public key', function () {
    ...
    assert.strictEqual(add.toString('hex'), 'd658a4b8247c14868f3c512fa5cbb6e458e4a989')
  })
})
...
describe('generateAddress with nonce 0 (special case)', function () {
  it('should produce an address given a public key', function () {
    ...
    assert.strictEqual(add.toString('hex'), 'bfa69ba91385206bfdd2d8b9c1a5d6c10097a85b')
  })
})
...
describe('hex prefix', function () {
  ...
  it('should add', function () {
    assert.strictEqual(ethUtils.addHexPrefix(string), '0x' + string)
  })
  it('should return on non-string input', function () {
    assert.strictEqual(ethUtils.addHexPrefix(1), 1)
  })
})

describe('isPrecompiled', function () {
  it('should return true', function () {
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000001'), true)
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000002'), true)
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000003'), true)
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000004'), true)
  })
  it('should return false', function () {
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000000'), false)
    assert.strictEqual(ethUtils.isPrecompiled('0000000000000000000000000000000000000005'), false)
    assert.strictEqual(ethUtils.isPrecompiled('1000000000000000000000000000000000000000'), false)
  })
})
...
describe('toBuffer', function () {
  it('should work', function () {
    // Buffer
    assert.deepStrictEqual(ethUtils.toBuffer(Buffer.allocUnsafe(0)), Buffer.allocUnsafe(0))
    // Array
    assert.deepStrictEqual(ethUtils.toBuffer([]), Buffer.allocUnsafe(0))
    // String
    assert.deepStrictEqual(ethUtils.toBuffer('11'), Buffer.from([49, 49]))
    assert.deepStrictEqual(ethUtils.toBuffer('0x11'), Buffer.from([17]))
    assert.deepStrictEqual(ethUtils.toBuffer('1234').toString('hex'), '31323334')
    assert.deepStrictEqual(ethUtils.toBuffer('0x1234').toString('hex'), '1234')
    // Number
    assert.deepStrictEqual(ethUtils.toBuffer(1), Buffer.from([1]))
    // null
    assert.deepStrictEqual(ethUtils.toBuffer(null), Buffer.allocUnsafe(0))
    // undefined
    assert.deepStrictEqual(ethUtils.toBuffer(), Buffer.allocUnsafe(0))
    // 'toArray'
    assert.deepStrictEqual(ethUtils.toBuffer(new BN(1)), Buffer.from([1]))
  })
...
describe('baToJSON', function () {
  it('should turn a array of buffers into a pure json object', function () {
    ...
    assert.deepStrictEqual(ethUtils.baToJSON(ba), ['0x00', '0x01', ['0x02']])
  })
  it('should turn a buffers into string', function () {
    assert.deepStrictEqual(ethUtils.baToJSON(Buffer.from([0])), '0x00')
  })
})
...
describe('ecsign', function () {
  it('should produce a signature', function () {
    ...
    assert.deepStrictEqual(sig.r, Buffer.from('99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9', 'hex'))
    assert.deepStrictEqual(sig.s, Buffer.from('129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66', 'hex'))
    assert.strictEqual(sig.v, 0)
  })
})
...
describe('ecrecover', function () {
  it('should recover a public key', function () {
    ...
    assert.deepStrictEqual(pubkey, ethUtils.privateToPublic(ecprivkey))
  })
...
describe('hashPersonalMessage', function () {
  it('should produce a deterministic hash', function () {
    ...
    assert.deepStrictEqual(h, Buffer.from('8144a6fa26be252b86456491fbcd43c1de7e022241845ffea1c3df066f7cfede', 'hex'))
  })
})
...
describe('isValidSignature', function () {
  it('should fail on an invalid signature (shorter r))', function () {
    ...
    var s = Buffer.from('129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66', 'hex')
    assert.strictEqual(ethUtils.isValidSignature(0, r, s), false)
  })
  ...
  it('should fail on an invalid signature (v = 21)', function () {
    var r = Buffer.from('99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9', 'hex')
    var s = Buffer.from('129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66', 'hex')
    assert.strictEqual(ethUtils.isValidSignature(21, r, s), false)
  })
  it('should fail on an invalid signature (v = 29)', function () {
    var r = Buffer.from('99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9', 'hex')
    var s = Buffer.from('129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66', 'hex')
    assert.strictEqual(ethUtils.isValidSignature(2, r, s), false)
  })
  it('should work otherwise', function () {
    var r = Buffer.from('99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9', 'hex')
    var s = Buffer.from('129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66', 'hex')
    assert.strictEqual(ethUtils.isValidSignature(0, r, s), true)
  })
...
describe('.toChecksumAddress()', function () {
  it('should work', function () {
    for (var i = 0; i < checksumAddresses.length; i++) {
      ...
      assert.strictEqual(ethUtils.toChecksumAddress(tmp.toLowerCase()), tmp)
    }
  })
})
...
describe('.isValidChecksumAddress()', function () {
  it('should return true', function () {
    for (var i = 0; i < checksumAddresses.length; i++) {
      assert.strictEqual(ethUtils.isValidChecksumAddress(checksumAddresses[i]), true)
    }
  })
  it('should validate', function () {
    assert.strictEqual(ethUtils.isValidChecksumAddress('0x2f015c60e0be116b1f0cd534704db9c92118fb6a'), false)
  })
})

describe('.isValidAddress()', function () {
  it('should return true', function () {
    assert.strictEqual(ethUtils.isValidAddress('0x2f015c60e0be116b1f0cd534704db9c92118fb6a'), true)
    assert.strictEqual(ethUtils.isValidAddress('0x52908400098527886E0F7030069857D2E4169EE7'), true)
  })
  it('should return false', function () {
    assert.strictEqual(ethUtils.isValidAddress('2f015c60e0be116b1f0cd534704db9c92118fb6a'), false)
    assert.strictEqual(ethUtils.isValidAddress('0x2f015c60e0be116b1f0cd534704db9c92118fb6'), false)
    assert.strictEqual(ethUtils.isValidAddress('0x2f015c60e0be116b1f0cd534704db9c92118fb6aa'), false)
    assert.strictEqual(ethUtils.isValidAddress('x2f015c60e0be116b1f0cd534704db9c92118fb6a'), false)
  })
})
...
describe('message sig', function () {
  ...
  it('should return hex strings that the RPC can use', function () {
    assert.strictEqual(ethUtils.toRpcSig(0, r, s), '0x99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca6600')
    assert.deepStrictEqual(ethUtils.fromRpcSig('0x99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca6600'), {
      v: 0,
      r: r,
      s: s
    })
  ...
  it('pad short r and s values', function () {
    assert.strictEqual(ethUtils.toRpcSig(0, r.slice(20), s.slice(20)), '0x00000000000000000000000000000000000000004a1579cf389ef88b20a1abe90000000000000000000000000000000000000000326fa689f228040429e3ca6600')
  })
